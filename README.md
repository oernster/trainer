...
![Status](https://img.shields.io/badge/status-ready%20for%20development-orange.svg)
...
```
┌─────────────────────────────────────────────────────────────┐
│ [🚂] Fleet → London Waterloo Train Times [🌙] [⚙️] [❌]    │
├─────────────────────────────────────────────────────────────┤
│ Last Updated: 20:35:42 │ Showing trains for next 10 hours  │
│ Next Update: 1m 23s    │                          [🔄]     │
├─────────────────────────────────────────────────────────────┤
│ 🚂 20:45 → London Waterloo          Platform 2 🚉         │
│    South Western Railway • Fast • 47m    ✅ On Time        │
│    Current: Woking 📍              Arrives: 21:32 🏁       │
├─────────────────────────────────────────────────────────────┤
│ 🚂 20:52 → London Waterloo          Platform 1 🚉         │
│    South Western Railway • Stop • 52m   ⚠️ 3m Late        │
│    Current: Fleet 📍               Arrives: 21:44 🏁       │
├─────────────────────────────────────────────────────────────┤
│ ... (up to 50 trains over 10 hours)                        │
├─────────────────────────────────────────────────────────────┤
│ Status: Connected • 45 trains • Theme: Dark • Auto-refresh │
└─────────────────────────────────────────────────────────────┘
```

**Note**: [🚂] represents the custom train icon from `assets/train_icon.svg`
