...
class TestAPODService:
    ...
    @pytest.mark.asyncio
    async def test_fetch_events_invalid_date_format(self, apod_service, mock_http_client):
    ...
    @pytest.mark.asyncio
    async def test_fetch_events_single_item_response(self, apod_service, mock_http_client):
...
class TestAstronomyAPIManager:
    ...
    @pytest.mark.asyncio
    async def test_get_astronomy_forecast_no_location(self, api_manager, mock_astronomy_source, mock_config):
...
class TestISSService:
    ...
    async def test_fetch_events_success(self, iss_service, mock_http_client):
        ...
        mock_response = AstronomyAPIResponse(
            ...
            data={
                "response": [
                    {
                        "risetime": 1718712000,  # 2024-06-18 12:00:00
                        "duration": 600
                    },
                    {
                        "risetime": 1718798400,  # 2024-06-19 12:00:00
                        "duration": 300
                    }
                ]
            },
    ...
    async def test_fetch_events_network_error_html(self, iss_service, mock_http_client):
        ...
        mock_http_client.get.side_effect = AstronomyNetworkException("text/html response")
    ...
    @pytest.mark.asyncio
    async def test_fetch_events_network_error_other(self, iss_service, mock_http_client):
        """Test fetch_events with other network error."""
        mock_http_client.get.side_effect = AstronomyNetworkException("Connection timeout")
    ...
    @pytest.mark.asyncio
    async def test_fetch_events_unexpected_data_type(self, iss_service, mock_http_client):
...
class TestNeoWsService:
    ...
    @pytest.mark.asyncio
    async def test_fetch_events_non_hazardous_large(self, neows_service, mock_http_client):
    ...
    @pytest.mark.asyncio
    async def test_fetch_events_no_interesting_objects(self, neows_service, mock_http_client):
    ...
    @pytest.mark.asyncio
    async def test_fetch_events_invalid_date_format(self, neows_service, mock_http_client):
        """Test fetch_events with invalid date format in response."""
        mock_response = AstronomyAPIResponse(
            status_code=200,
            data={
    ...
    @pytest.mark.asyncio
    async def test_fetch_events_unexpected_data_type(self, neows_service, mock_http_client):
        """Test fetch_events with unexpected data type."""
        mock_response = AstronomyAPIResponse(
            status_code=200,
            data={"unexpected": "string data"},
    ...
    def test_get_max_diameter_invalid_type(self, neows_service):
        ...
        obj = {
            "estimated_diameter": {
                "meters": {
                    "estimated_diameter_max": "invalid"
                }
            }
        }
        diameter = neows_service._get_max_diameter(obj)
...
class TestEPICService:
    ...
    def test_get_base_url(self, epic_service):
        """Test get_base_url method."""
        assert epic_service.get_base_url() == "https://api.nasa.gov/EPIC/api/natural/images"
    ...
    @pytest.mark.asyncio
    async def test_fetch_epic_for_date_invalid_response(self, epic_service, mock_http_client):
...
class TestNASAAstronomySource:
    ...
    @pytest.mark.asyncio
    async def test_fetch_astronomy_data_service_failure(self, nasa_source, mock_http_client):
    ...
    @pytest.mark.asyncio
    async def test_fetch_astronomy_data_validation_failure(self, nasa_source, mock_http_client):
    ...
    async def test_fetch_service_data_success(self, nasa_source):
        ...
        events = await nasa_source._fetch_service_data(mock_service, location, start_date, end_date)
        
        assert len(events) == 1
        mock_service.fetch_events.assert_called_once_with(location, start_date, end_date)
    ...
    def test_combine_service_results(self, nasa_source):
        ...
        daily_astronomy = nasa_source._combine_service_results(service_results, today, tomorrow)
...
class TestRateLimitedAstronomySource:
    ...
    @pytest.mark.asyncio
    async def test_fetch_astronomy_data_under_limit(self, rate_limited_source, mock_source):
    ...
    @pytest.mark.asyncio
    async def test_fetch_astronomy_data_rate_limit_reached(self, rate_limited_source, mock_source):
...
class TestAstronomyAPIManagerAdditional:
    ...
    @pytest.mark.asyncio
    async def test_get_astronomy_forecast_with_stale_cache_fallback(self, api_manager, mock_astronomy_source, mock_config):
    ...
    @pytest.mark.asyncio
    async def test_get_astronomy_forecast_no_cache_on_error(self, api_manager, mock_astronomy_source):
