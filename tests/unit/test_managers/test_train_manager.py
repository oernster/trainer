    ...
    def test_fetch_trains_starts_async_fetch(self, train_manager):
        ...
        with patch.object(train_manager, '_start_async_fetch') as mock_start:
            with patch('PySide6.QtCore.QTimer.singleShot') as mock_single_shot:
                ...
                mock_single_shot.assert_called_once_with(0, train_manager._start_async_fetch)

    def test_process_train_data_with_cancelled_shown(self, train_manager, sample_trains):
        ...
        assert result[0].departure_time <= result[1].departure_time <= result[2].departure_time

    def test_process_train_data_with_cancelled_hidden(self, train_manager, sample_trains):
