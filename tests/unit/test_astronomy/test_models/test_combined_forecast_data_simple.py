...
from src.models.astronomy_data import AstronomyData, AstronomyForecastData, AstronomyEvent, AstronomyEventType
...
class TestCombinedForecastDataBasic:
    ...
    def test_combined_forecast_validation_empty_forecasts(self):
        ...
        with pytest.raises(ValueError, match="Combined forecast must contain at least one daily forecast"):
            CombinedForecastData(
                location=location,
                daily_forecasts=[]
            )
