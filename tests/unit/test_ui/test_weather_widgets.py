...
def test_weather_widgets_comprehensive_coverage():
    ...
    try:
        ...
        forecast_widget.update_weather_forecast(
            weather_data_list, is_daily=False, config=mock_config_instance
        )
        forecast_widget.update_weather_forecast(
            weather_data_list, is_daily=True, config=mock_config_instance
        )
        forecast_widget.update_weather_forecast(
            weather_data_list, is_daily=True
        )  # Without config
        ...
        daily_widget.update_daily_forecast(
            [mock_weather_instance], mock_config_instance
        )
        ...
        hourly_widget.update_hourly_forecast(
            [mock_weather_instance], mock_config_instance
        )
