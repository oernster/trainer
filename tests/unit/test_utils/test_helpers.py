...
from src.utils.helpers import (
    format_time, format_duration, get_time_group,
    group_trains_by_time, calculate_journey_stats,
    filter_trains_by_status, sort_trains_by_departure,
    get_next_departure, format_relative_time,
    validate_time_window, validate_refresh_interval,
    get_status_summary
)
...
class TestJourneyStats:
    ...
    def create_test_train(self, status=TrainStatus.ON_TIME, delay=0, service_type=ServiceType.FAST):
        """Helper to create test train data."""
