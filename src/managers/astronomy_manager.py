...
class AstronomyManager(QObject):
    ...
    def _initialize_api_manager(self) -> None:
        ...
        try:
            self._api_manager = AstronomyAPIFactory.create_manager_from_config(self._config)
    ...
    async def refresh_astronomy(self, force_refresh: bool = False) -> Optional[AstronomyForecastData]:
        ...
        try:
            ...
            logger.info(f"Astronomy data refreshed successfully: {forecast_data.total_events} events")
    ...
    def start_auto_refresh(self) -> None:
        ...
        logger.info(f"Astronomy auto-refresh started (interval: {interval_ms/1000:.0f}s)")
    ...
    def get_status_summary(self) -> str:
        ...
        if self.is_data_stale():
            return f"Astronomy data stale ({self._current_forecast.total_events} events)"
