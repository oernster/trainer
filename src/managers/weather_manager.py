...
class RefreshWeatherCommand(WeatherCommand):
    ...
    def __init__(self, weather_manager: 'WeatherManager', location: Optional[Location] = None):
...
class WeatherManager(QObject, WeatherSubject):
    ...
    def start_auto_refresh(self) -> None:
        ...
        logger.info(f"Auto-refresh started with {self._config.refresh_interval_minutes}min interval")
    ...
    async def _fetch_weather_internal(self, location: Optional[Location] = None) -> None:
        ...
        try:
            ...
            logger.info(f"Weather data refreshed successfully (fetch #{self._fetch_count})")
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "success_rate": (
                (self._fetch_count - self._error_count) / max(self._fetch_count, 1) * 100
            ),
